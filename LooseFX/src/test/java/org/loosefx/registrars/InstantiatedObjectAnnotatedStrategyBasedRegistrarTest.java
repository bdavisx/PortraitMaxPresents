...
public class InstantiatedObjectAnnotatedStrategyBasedRegistrarTest {
  ...
  public void itShouldRegisterAnnotatedMethods() throws Exception {
    ...
    Assert.assertTrue( itemBeingRegistrared.receivedEvents.stream().anyMatch( e -> e.getEventId().equals( event1Id ) ) );
    Assert.assertTrue( itemBeingRegistrared.receivedEvents.stream().anyMatch( e -> e.getEventId().equals( event2Id ) ) );
  }
  ...
  public class TestRegister extends AbstractAggregateRoot {
