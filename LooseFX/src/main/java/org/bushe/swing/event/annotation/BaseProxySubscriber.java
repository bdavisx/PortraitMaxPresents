...
public class BaseProxySubscriber extends AbstractProxySubscriber
     ...
     */
    public BaseProxySubscriber( final Object proxiedSubscriber, final Method subscriptionMethod,
    ...
    public BaseProxySubscriber( final Object proxiedSubscriber, final Method subscriptionMethod,
        ...
        if( params == null || params.length != 1 || params[0].isPrimitive() ) {
            throw new IllegalArgumentException(
                "The subscriptionMethod must have a single non-primitive parameter." );
        }
    }
    ...
    public void onEvent( final Object event ) {
        ...
        try {
            ...
            final String message =
                "Exception when invoking annotated method from EventService publication.  Event class:" +
                    event.getClass() + ", Event:" + event + ", subscriber:" + getProxiedSubscriber() +
            ...
            throw new RuntimeException(
                "InvocationTargetException when invoking annotated method from EventService publication.  Event class:" +
                    event.getClass() + ", Event:" + event + ", subscriber:" + getProxiedSubscriber() +
