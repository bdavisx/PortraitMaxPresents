...
public interface EventSubscriber<T> {
    ...
    /**
     Handle a published event. <p>The EventService calls this method on each publication of an object that matches
     the class or interface passed to one of the EventService's class-based subscribe methods, specifically, {@link
