...
/**
 ...
 <p/>
 This annotation simplifies much of the repetitive boilerplate used for adding veto topic listeners (which in
 EventBus 2.0 will be called VetoTopicSubscribers, thus this annotation name difference) to EventService Events.
 Example:
 <p/>
 <pre>
