...
/**
 ...
 <p/>
 This annotation simplifies much of the repetitive boilerplate used for adding veto listeners (which in EventBus 2.0
 will be called VetoSubscribers, thus this annotation name difference) to EventService Events.  Example:
 <p/>
 <pre>
